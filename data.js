(function () {
  ...
  const TIERS = [
    { price: 400,  build: [300, 560, 1040, 1760, 2720, 4000, 6000],     toll: [80, 160, 260, 400, 580, 820, 1140, 1710] },
    { price: 800,  build: [600, 1120, 2080, 3520, 5440, 8000, 12000],   toll: [160, 320, 520, 800, 1160, 1640, 2280, 3420] },
    { price: 1200, build: [900, 1680, 3120, 5280, 8160, 12000, 18000],  toll: [240, 480, 780, 1200, 1740, 2460, 3420, 5130] },
    { price: 1600, build: [1200, 2240, 4160, 7040, 10880, 16000, 24000], toll: [320, 640, 1040, 1600, 2320, 3280, 4560, 6840] },
    { price: 2000, build: [1500, 2800, 5200, 8800, 13600, 20000, 30000], toll: [400, 800, 1300, 2000, 2900, 4100, 5700, 8550] },
    { price: 2400, build: [1800, 3360, 6240, 10560, 16320, 24000, 36000],toll: [480, 960, 1560, 2400, 3480, 4920, 6840, 10260] }
  ];
  ...
  const BUILD_NAMES = ["", "店铺", "商铺", "旅馆", "酒店", "大厦", "新城", "都市"];
