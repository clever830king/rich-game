(function () {
  ...
  const TIERS = [
    { price: 400,  build: [300, 560, 1040, 1760, 2720, 4000, 6000, 9000],      toll: [80, 160, 260, 400, 580, 820, 1140, 1710, 2565] },
    { price: 800,  build: [600, 1120, 2080, 3520, 5440, 8000, 12000, 18000],   toll: [160, 320, 520, 800, 1160, 1640, 2280, 3420, 5130] },
    { price: 1200, build: [900, 1680, 3120, 5280, 8160, 12000, 18000, 27000],  toll: [240, 480, 780, 1200, 1740, 2460, 3420, 5130, 7695] },
    { price: 1600, build: [1200, 2240, 4160, 7040, 10880, 16000, 24000, 36000], toll: [320, 640, 1040, 1600, 2320, 3280, 4560, 6840, 10260] },
    { price: 2000, build: [1500, 2800, 5200, 8800, 13600, 20000, 30000, 45000], toll: [400, 800, 1300, 2000, 2900, 4100, 5700, 8550, 12825] },
    { price: 2400, build: [1800, 3360, 6240, 10560, 16320, 24000, 36000, 54000],toll: [480, 960, 1560, 2400, 3480, 4920, 6840, 10260, 15390] }
  ];
  ...
  const BUILD_NAMES = ["", "店铺", "商铺", "旅馆", "酒店", "大厦", "新城", "新区", "都市"];
  ...
  const FATE = [
    ...
    { name: "舟山台风", type: "moneyPct", pct: -15, desc: "港口关闭，损失 ¥1500" },
    { name: "雁荡山封路", type: "back3", desc: "景区封路，向后移动 3 格" },
    { name: "绍兴黄酒破损", type: "moneyPct", pct: -12, desc: "运输破损，损失 ¥1200" },
    { name: "千岛湖涨价", type: "moneyPct", pct: -10, desc: "旺季涨价，损失 ¥1000" },
    { name: "南浔古镇爆红", type: "moneyPct", pct: 15, desc: "生意爆红，获得 ¥1800" },
    { name: "宁波港顺风", type: "moneyPct", pct: 15, desc: "货物提前抵达，获得 ¥2000" },
    { name: "义乌订单暴涨", type: "moneyPct", pct: 15, desc: "订单暴涨，获得 ¥1500" },
    { name: "天台山祈福", type: "moneyPct", pct: 10, desc: "祈福好运，获得 ¥1000" },
    ...
    { name: "金华火腿滞销", type: "moneyPct", pct: -8, desc: "金华火腿滞销，损失 ¥800" },
    { name: "衢州柑橘丰收", type: "moneyPct", pct: 6, desc: "衢州柑橘丰收，获得 ¥600" },
    { name: "丽水山货热卖", type: "moneyPct", pct: 6, desc: "丽水山货热卖，获得 ¥700" },
    ...
    { name: "绍兴黄酒畅销", type: "moneyPct", pct: 8, desc: "绍兴黄酒畅销，获得 ¥900" },
    { name: "温州鞋厂订单", type: "moneyPct", pct: 12, desc: "温州鞋厂订单，获得 ¥1200" },
    { name: "嘉兴粽子热卖", type: "moneyPct", pct: 8, desc: "嘉兴粽子热卖，获得 ¥800" },
    { name: "金华火腿畅销", type: "moneyPct", pct: 10, desc: "金华火腿畅销，获得 ¥1100" },
    { name: "湖州丝绸出口", type: "moneyPct", pct: 12, desc: "湖州丝绸出口，获得 ¥1300" },
    { name: "丽水山路塌方", type: "moneyPct", pct: -8, desc: "丽水山路塌方，损失 ¥900" },
    { name: "台州台风损失", type: "moneyPct", pct: -10, desc: "台州台风损失 ¥1100" },
    { name: "宁波港拥堵", type: "moneyPct", pct: -6, desc: "宁波港拥堵，损失 ¥700" },
    { name: "嘉兴暴雨损失", type: "moneyPct", pct: -6, desc: "嘉兴暴雨损失 ¥600" },
    { name: "湖州茧价下跌", type: "moneyPct", pct: -10, desc: "湖州茧价下跌，损失 ¥1000" },
    { name: "衢州柑橘滞销", type: "moneyPct", pct: -5, desc: "衢州柑橘滞销，损失 ¥500" }
  ];
  ...
  const OPPORTUNITY = [
    { name: "义乌小商品进货", invest: 1000, winPct: 14, losePct: 9 },
    { name: "宁波港临时订单", invest: 0, winPct: 13, losePct: 6 },
    { name: "温州商人合作", invest: 1500, winPct: 14, losePct: 12 },
    { name: "杭州旅游项目", invest: 2000, winPct: 15, losePct: 12 },
    { name: "嘉兴特产批发", invest: 800, winPct: 12, losePct: 8 },
    { name: "绍兴黄酒代理", invest: 600, winPct: 10, losePct: 7 },
    { name: "千岛湖民宿投资", invest: 1200, winPct: 13, losePct: 10 },
    { name: "舟山海鲜市场", invest: 500, winPct: 10, losePct: 6 },
    { name: "丽水旅游开发", invest: 1000, winPct: 13, losePct: 9 },
    { name: "浙江创业大奖", invest: 2000, winPct: 15, losePct: 12 },
    { name: "卡牌商人进货", invest: 500, winPct: 9, losePct: 6, winCard: 1 },
    { name: "神秘卡包", invest: 800, winPct: 9, losePct: 8, winCard: 2, loseCard: 1 },
    { name: "西湖龙井茶庄", invest: 1000, winPct: 10, losePct: 9 },
    { name: "乌镇民宿投资", invest: 1500, winPct: 14, losePct: 5 },
    { name: "宁波舟山港物流", invest: 1200, winPct: 10, losePct: 10 },
    { name: "温州鞋厂订单", invest: 800, winPct: 12, losePct: 5 },
    { name: "台州模具厂", invest: 1000, winPct: 10, losePct: 8 },
    { name: "湖州丝绸外贸", invest: 1200, winPct: 13, losePct: 10, winCard: 1 },
    { name: "金华火腿电商", invest: 600, winPct: 10, losePct: 7 },
    { name: "丽水山货直播", invest: 500, winPct: 10, losePct: 6, winCard: 1 },
    { name: "西湖游船经营", invest: 800, winPct: 12, losePct: 8, winCard: 1 },
    { name: "南浔古镇商铺", invest: 1000, winPct: 13, losePct: 9, winCard: 1 },
    { name: "普陀山民宿", invest: 1500, winPct: 14, losePct: 12, winCard: 1 },
    { name: "雁荡山旅游", invest: 900, winPct: 12, losePct: 8, winCard: 1 },
    { name: "千岛湖游船", invest: 700, winPct: 10, losePct: 7, winCard: 1 },
    { name: "莫干山民宿", invest: 1300, winPct: 14, losePct: 10, winCard: 1 },
    { name: "西塘酒吧", invest: 600, winPct: 10, losePct: 7, winCard: 1 },
    { name: "兰亭文创", invest: 500, winPct: 10, losePct: 6, winCard: 1 },
    { name: "楠溪江漂流", invest: 800, winPct: 12, losePct: 8, winCard: 1 },
    { name: "江郎山缆车", invest: 1000, winPct: 13, losePct: 9, winCard: 1 },
    { name: "云和梯田民宿", invest: 900, winPct: 12, losePct: 8, winCard: 1 },
    { name: "石塘渔家乐", invest: 700, winPct: 10, losePct: 7, winCard: 1 },
    { name: "东极岛海钓", invest: 600, winPct: 10, losePct: 7, winCard: 1 },
    { name: "绍兴黄酒直播", invest: 800, winPct: 12, losePct: 8, winCard: 1 },
    { name: "义乌电商直播", invest: 1000, winPct: 13, losePct: 9, winCard: 1 },
    { name: "嘉兴南湖游船", invest: 700, winPct: 10, losePct: 7, winCard: 1 },
    { name: "湖州丝绸电商", invest: 900, winPct: 12, losePct: 8, winCard: 1 },
    { name: "衢州柑橘电商", invest: 500, winPct: 9, losePct: 6, winCard: 1 },
    { name: "丽水山货电商", invest: 600, winPct: 10, losePct: 7, winCard: 1 },
    { name: "台州海鲜直播", invest: 800, winPct: 12, losePct: 8, winCard: 1 },
    { name: "风险卡包", invest: 600, winPct: 8, losePct: 7, loseCard: 1 },
    { name: "赌徒卡包", invest: 500, winPct: 8, losePct: 6, loseCard: 1 },
    { name: "危险卡盒", invest: 700, winPct: 9, losePct: 7, loseCard: 1 },
    { name: "绍兴黄酒代理2", invest: 600, winPct: 10, losePct: 7 },
    { name: "温州鞋厂订单2", invest: 800, winPct: 12, losePct: 8 },
    { name: "杭州西湖游船2", invest: 900, winPct: 13, losePct: 8 },
    { name: "宁波港订单2", invest: 0, winPct: 13, losePct: 7 },
    { name: "嘉兴粽子批发", invest: 500, winPct: 10, losePct: 6 },
    { name: "金华火腿代理", invest: 700, winPct: 12, losePct: 7 },
    { name: "湖州丝绸代理", invest: 800, winPct: 12, losePct: 8 },
    { name: "丽水山货批发", invest: 600, winPct: 10, losePct: 7 },
    { name: "台州模具订单", invest: 1000, winPct: 13, losePct: 9 },
    { name: "衢州柑橘批发", invest: 500, winPct: 9, losePct: 6 }
  ];
